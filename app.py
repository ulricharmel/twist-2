    ...
    [
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.H4("Band loan customers confidence", className="app__header__title"),
                        html.P(
                            "This app continually queries a SQL database and displays predicted confidence score for each cumstomer",
                ...
                html.Div(
                    [
                        html.A(
                            ...
                            href="https://github.com/ulricharmel/twist-2",
                        ),
                        html.A(
